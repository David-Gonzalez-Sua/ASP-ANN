...
# existing_model_filename = f"Adaptive_Network/Python_ANN/trained_models/ptm_2000_15e_10a.npy"
...
manual_testing_routine = False

# Set training parameters
train_model = True
training_amount = 6000  # Number of training samples to use: 0-60000
test_model = True
testing_amount = 6000  # Number of testing samples to use: 0-10000
